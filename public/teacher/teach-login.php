...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $stmt = $conn->prepare("SELECT id, full_name, password FROM teachers WHERE login = ?");
...
<head>
    ...
    <title>Вход для преподавателя - Учебный портал</title>
    ...
    <style>
        ...
        * {
        ...
        input:focus {
            ...
            box-shadow: 0 0 0 3px rgba(169, 132, 193, 0.2);
        }
    ...
    <div class="login-container">
        ...
        <form method="POST" class="login-form">
            ...
            <div class="form-group">
                ...
                <input type="password" id="password" name="pass" placeholder="Введите пароль" required>
            </div>
